...
const ModalValidatePayment = ({ onClose, dataPayment }) => {
  const { dataEvidencia, extension, comentario, estado } = dataPayment;
  ...
  return (
    <Paper>
      ...
      <Divider />
      <Grid container styles="containerButtom" justify="flex-end">
        <Grid item xs={2}>
          <Button
            fullWidth
            size="large"
...
ModalValidatePayment.propTypes = {
  onClose: PropTypes.func.isRequired,
  dataPayment: PropTypes.objectOf(PropTypes.object).isRequired,
}

export default ModalValidatePayment;
